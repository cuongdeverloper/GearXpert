...
export default function MyRentals() {
  ...
  const handleConfirmExtend = async () => {
    try {
      ...
      toast.error(err.response?.data?.message || "Gửi yêu cầu gia hạn thất bại");
    }
  };
            ...
            <div className="bg-white rounded-3xl border border-gray-100 p-6 lg:sticky lg:top-24">
              <div className="flex items-end justify-between mb-4">
                ...
                <div className="text-[11px] font-bold text-gray-400">
                  {reportsForSidebar.length} gần nhất
                </div>
              </div>
          ...
          <aside className="lg:col-span-3">
            <div className="bg-white rounded-3xl border border-gray-100 p-6 lg:sticky lg:top-24">
              <div className="flex items-end justify-between mb-4">
                ...
                <div className="text-[11px] font-bold text-gray-400">
                  {extendRequestsForSidebar.length} gần nhất
                </div>
              </div>

              {extendRequestsForSidebar.length === 0 ? (
