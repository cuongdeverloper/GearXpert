...
const mockData = [
  {
    ...
    status: "PENDING",
    scheduled: "2026-02-06 14:30",
    priority: "Cao",
    note: "Giao trước 15h, khách yêu cầu gọi trước 30 phút",
  },
  {
    id: "DT002",
    rentalId: "R124",
    ...
    status: "IN_TRANSIT",
    scheduled: "2026-02-05 09:00",
    priority: "Trung bình",
    note: "Khách ở tầng 5, có thang máy",
  },
  {
    id: "DT003",
    rentalId: "R127",
    ...
    priority: "Cao",
    note: "Giao cẩn thận, thiết bị nhạy cảm",
  },
  {
    id: "DT004",
    rentalId: "R129",
...
export default function DeliveryTab() {
  ...
  const handleConfirmSuccess = () => {
    if (evidenceFiles.length === 0) {
      alert("Vui lòng upload ít nhất 1 ảnh bằng chứng giao hàng thành công!");
      return;
    }
    alert(`Đã xác nhận giao thành công cho đơn ${selectedTask.rentalId}`);
  ...
  const handleConfirmFail = () => {
    ...
    alert(`Đã báo cáo giao thất bại cho đơn ${selectedTask.rentalId}. Lý do: ${failReason}`);
    // Gọi API update status + reason
  ...
  const handleConfirmCancel = () => {
    ...
    alert(`Đã hủy task ${selectedTask.id}. Lý do: ${cancelReason}`);
    // Gọi API cancel task
    ...
    <div className="space-y-6">
          ...
          <table className="min-w-full divide-y divide-gray-200">
            <thead className="bg-gray-50">
              <tr>
                ...
                <th className="px-6 py-4 text-left text-sm font-semibold text-gray-700">Lịch giao</th>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-2xl p-6 max-w-2xl w-full mx-4 max-h-[90vh] overflow-y-auto">
            <div className="flex justify-between items-center mb-6">
              <h3 className="text-xl font-bold">Chi tiết giao hàng: {selectedTask.id}</h3>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                <p className="text-sm font-medium text-gray-600">Lịch giao</p>
      ...
      {showSuccessModal && selectedTask && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-2xl p-6 max-w-lg w-full mx-4">
            <div className="flex justify-between items-center mb-6">
              <h3 className="text-xl font-bold text-green-700">Xác nhận giao hàng thành công</h3>
            ...
            <div className="mb-6">
              <label className="block text-sm font-medium text-gray-700 mb-2">
                Bằng chứng giao hàng (ảnh/video)
              </label>
              <div className="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center">
                ...
                >
                  ...
                  <span className="text-sm text-gray-500 mt-1">hoặc kéo thả ảnh/video</span>
                </label>
              </div>
            ...
            <div className="mb-6">
              ...
              <textarea
                ...
                rows={3}
                placeholder="Ghi chú thêm nếu có (ví dụ: giao tận tay, khách hài lòng...)"
              />
            </div>
      ...
      {showFailModal && selectedTask && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-2xl p-6 max-w-lg w-full mx-4">
            <div className="flex justify-between items-center mb-6">
              <h3 className="text-xl font-bold text-red-700">Báo cáo giao hàng thất bại</h3>
            ...
            <div className="mb-6">
              <label className="block text-sm font-medium text-gray-700 mb-2">
                Lý do giao thất bại <span className="text-red-600">*</span>
              </label>
              <textarea
                value={failReason}
                ...
                rows={4}
                placeholder="Nhập lý do chi tiết (ví dụ: Khách không có nhà, sai địa chỉ, từ chối nhận...)"
                required
              />
            </div>
            ...
            <div className="mb-6">
              ...
              <div className="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center">
                <input
                  ...
                  onChange={handleFileChange}
                  className="hidden"
                  id="fail-evidence-upload"
                />
                <label
                  htmlFor="fail-evidence-upload"
                  className="cursor-pointer flex flex-col items-center"
                >
                  <Upload size={32} className="text-indigo-600 mb-2" />
      ...
      {showCancelModal && selectedTask && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-2xl p-6 max-w-lg w-full mx-4">
            <div className="flex justify-between items-center mb-6">
              <h3 className="text-xl font-bold text-orange-700">Hủy task giao hàng</h3>
            ...
            <div className="mb-6">
              ...
              <textarea
                ...
                rows={4}
                placeholder="Nhập lý do hủy task (ví dụ: Thiết bị hết hàng, khách hủy đơn...)"
                required
              />
            </div>
