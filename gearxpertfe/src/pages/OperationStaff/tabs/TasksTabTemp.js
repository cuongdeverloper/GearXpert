          ...
          <div className="flex p-1 bg-slate-100/80 rounded-xl md:rounded-full overflow-x-auto hide-scrollbar w-full md:w-auto shrink-0 snap-x">
            {[
              ...
              <button
                ...
                className={`flex-1 min-w-[90px] md:min-w-fit px-4 py-2 text-sm font-semibold rounded-lg md:rounded-full whitespace-nowrap transition-all snap-center ${activeTab === tab.id
              ...
              >
                ...
                <div className="p-4 space-y-3 flex-1">
                  <div>
                    ...
                    <div className="flex items-center gap-1.5 text-[11px] text-primary font-semibold mt-1">
                      <Calendar size={13} />
            ...
            <div className="flex-1 overflow-y-auto p-5 md:p-6 space-y-6">
              ...
              <div className="bg-white p-5 rounded-2xl border border-slate-200 shadow-sm space-y-4">
                <div className="flex items-center gap-2 border-b border-slate-100 pb-3">
                  ...
                  <h4 className="font-bold text-slate-900 text-[15px]">Thời gian thuê</h4>
                </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                ...
                {isDeliveryTask && hasOwner && !isSelectedLockedByOther && (
                  <button
                    ...
                    className={`${openRecordButtonBaseClass} ${showHandoverAsPrimaryCta
