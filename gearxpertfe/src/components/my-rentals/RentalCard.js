...
const statusMeta = (order) => {
  ...
  switch (order.status) {
    ...
    case "DELIVERING": {
      ...
      // Check actual delivery state based on order data
      ...
      if (order.assignedOperationStaffId) {

        return {

          label: "Staff đang lấy hàng",
...
export default function RentalCard({
  ...
  const handleClick = (fn) => (e) => {
    ...
    if (typeof fn === 'function') {
      ...
      console.warn('handleClick: fn is not a function', fn);
        ...
        <div className="flex flex-wrap gap-2">
          ...
          <button
            ...
            onClick={(e) => {
              ...
              console.log('Confirm received clicked for order:', order._id);

              if (typeof onConfirmReceived === 'function') {

                onConfirmReceived();

              } else {

                console.error('onConfirmReceived is not a function:', onConfirmReceived);

              }

            }}

            className="px-4 py-2.5 rounded-xl bg-indigo-600 hover:bg-indigo-700 text-white text-sm font-black inline-flex items-center gap-2 cursor-pointer"
        ...
        <div className="flex flex-wrap gap-2">
          ...
          {hasReviewed ? (
            ...
            <button
              ...
              className="px-4 py-2.5 rounded-xl bg-gradient-to-r from-emerald-500 to-teal-500 text-white border-0 text-sm font-black inline-flex items-center gap-2 cursor-not-allowed shadow-lg shadow-emerald-200"

            >

              <Star size={16} fill="white" className="text-white" /> Đã đánh giá
          ...
          <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-3">
            ...
            <div className="flex items-center gap-3 min-w-0">
              ...
              <div className="w-12 h-12 rounded-2xl bg-slate-100 border border-slate-200 overflow-hidden flex items-center justify-center flex-shrink-0">
                ...
                {(supplier?.businessAvatar || supplier?.avatar) ? (

                  <img

                    src={supplier.businessAvatar || supplier.avatar}
              ...
              <div className="min-w-0">
                ...
                <div className="text-xs font-black text-slate-900 truncate">
                  ...
                  {supplier?.businessName || supplier?.fullName || "Nhà cung cấp"}
            ...
            <div className="text-right flex flex-col items-end gap-2">
              ...
              <button
                ...
                className="px-3 py-1.5 rounded-lg bg-slate-100 hover:bg-slate-200 text-slate-700 text-xs font-bold inline-flex items-center gap-1.5 transition-colors"
              ...
              {order.status === "DELIVERING" && (
                ...
                <button
                  ...
                  onClick={(e) => {
                    ...
                    onReportDelivery(order.items?.[0]);
