...
const SignIn = () => {
  ...
  return (
    <div className="min-h-screen relative overflow-hidden bg-background-light flex items-center justify-center p-4 md:p-6">
      ...
      <div className="relative z-10 w-full max-w-5xl">
        ...
        <div className="relative">
          <div className="relative bg-white rounded-3xl shadow-2xl overflow-hidden">
            <div className="grid md:grid-cols-2 relative min-h-[500px]">
              ...
              <div className="relative">
                ...
                <div className={`absolute inset-0 bg-gradient-to-br from-primary via-indigo-600 to-accent-cyan p-5 md:p-6 lg:p-8 flex flex-col justify-center transition-opacity duration-700 ease-in-out ${
                ...
                <div className={`absolute inset-0 hidden md:block transition-opacity duration-700 ease-in-out ${
              ...
              <div className="relative">
                ...
                <div className={`relative bg-white p-6 md:p-8 lg:p-10 flex flex-col justify-start transition-opacity duration-700 ease-in-out ${
                  isSignUp ? 'opacity-100' : 'opacity-0 pointer-events-none absolute inset-0'
                }`}>
          ...
          <button
            ...
            className={`absolute top-1/2 -translate-y-1/2 z-30 px-4 py-2 md:px-5 md:py-2.5 rounded-full bg-white shadow-2xl flex items-center justify-center text-primary hover:scale-110 transition-all duration-300 border-2 md:border-4 border-background-light font-semibold text-sm md:text-base whitespace-nowrap ${
              isSignUp 
