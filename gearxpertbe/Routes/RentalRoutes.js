...
const { checkoutRental, hasRentedDevice, verifyRentalPayment, getMyRentals, cancelRental, confirmReceived, extendRental } = require('../controllers/Rental/RentalController');
