...
router.post("/:handoverId/confirm-success", checkAccessToken, handoverController.confirmSuccess);
router.post("/:handoverId/fail", checkAccessToken, handoverController.fail);
